...
const originalPatterns: IShiftPattern[] = [
  ...
  // 夜勤系 (※時刻で自動判定されるため、crossesMidnight は不要)
  ...
  // その他
  { patternId: '公休', symbol: '公', name: '公休', mainCategory: '休み', workType: 'StatutoryHoliday', crossUnitWorkType: '-', startTime: '00:00', endTime: '00:00', breakDurationMinutes: 0, durationHours: 0, isNightShift: false },
...
// (以下省略: MOCK_UNITS_V5, MOCK_STAFF_V4 は変更なし)
...
export const MOCK_STAFF_V4: IStaff[] = [
  // スタッフA～H, 応援スタッフ (変更なし)
  { staffId: 's001', name: 'スタッフA', employmentType: 'FullTime', status: 'Active', skills: ['Leader'], unitId: 'U01', availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '全パターン対応' },
  { staffId: 's002', name: 'スタッフB', employmentType: 'FullTime', status: 'Active', skills: [], unitId: 'U01', availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '全パターン対応' },
  { staffId: 's003', name: 'スタッフC', employmentType: 'FullTime', status: 'Active', skills: [], unitId: 'U01', availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '全パターン対応' },
  { staffId: 's004', name: 'スタッフD', employmentType: 'FullTime', status: 'Active', skills: [], unitId: 'U01', availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '全パターン対応' },
  { staffId: 's005', name: 'スタッフE', employmentType: 'FullTime', status: 'Active', skills: [], unitId: 'U02', availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '全パターン対応' },
  { staffId: 's006', name: 'スタッフF', employmentType: 'FullTime', status: 'Active', skills: [], unitId: 'U02', availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '全パターン対応' },
  { staffId: 's007', name: 'スタッフG', employmentType: 'FullTime', status: 'Active', skills: [], unitId: 'U02', availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '全パターン対応' },
  { staffId: 's008', name: 'スタッフH', employmentType: 'FullTime', status: 'Active', skills: [], unitId: 'U02', availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '全パターン対応' },
  { staffId: 's009', name: '応援スタッフ1', employmentType: 'Rental', status: 'Active', skills: [], unitId: null, availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '応援スタッフ (全パターン対応)' },
  { staffId: 's010', name: '応援スタッフ2', employmentType: 'Rental', status: 'Active', skills: [], unitId: null, availablePatternIds: MOCK_PATTERNS_V5.map(p => p.patternId), constraints: getDefaultConstraints(), memo: '応援スタッフ (全パターン対応)' },
];